    ...
    return (
        <div className='w-[80%] h-[180px] px-4 py-8 flex flex-wrap justify-evenly items-center bg-white transition-shadow shadow-md rounded-lg'>
            {cardData.map(({ img, name, minides }) => (
                <div className='flex flex-col gap-4 items-center flex-[1_1_180px] max-w-[180px] not-last:border-r-2 border-blue-400/40 ' key={name}>
                    <Image className='w-[60px] h-auto ' src={img} alt={name} />
